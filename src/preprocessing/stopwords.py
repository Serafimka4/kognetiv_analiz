"""Русские стоп-слова для очистки текста перед тематическим моделированием."""
...
RU_STOPWORDS = {
    ...
    # частые «новостные» слова, шумящие в темах
    "это", "также", "которые", "который", "которая", "году", "год", "года",
    "сообщает", "сообщил", "заявил", "слова", "ранее", "стало", "стал",
    "рассказал", "отметил", "должен", "также", "млн", "млрд", "тыс",
    "рубль", "рубля", "рублей", "процент", "процента", "процентов",
}
